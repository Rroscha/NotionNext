...
const BLOG = {
  ...
  AUTHOR: 'Rroscha', // 您的昵称 例如 tangly1024
  BIO: 'Graduate student in ShanghaiTech University', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://rroscha.vercel.app/', // 网站地址
  KEYWORDS: 'Program Analysis, Malware Detection, Software Supply Chain, Race Detection, AI...', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'rrocsha1793@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/Rroscha', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  MUSIC_PLAYER_AUDIO_LIST: [ // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: '悪魔の子',
      artist: '芝麻Mochi',
      url: 'https://music.163.com/song/media/outer/url?id=1915004605.mp3',
      cover: 'http://p1.music.126.net/ZLDIZ043GGfr1FLyJ7FKiw==/109951166218105229.jpg?param=130y130'
    },
    {
      name: 'Bones',
      artist: 'Imagine Dragons',
      url: 'https://music.163.com/song/media/outer/url?id=1990938802.mp3',
      cover: 'https://p1.music.126.net/lk0BOzuFAPw2hQZG6PDiug==/109951167982656647.jpg?param=130y130'
    },
    {
      name: '风恋歌',
      artist: '恋恋故人难 / 芝麻Mochi',
      url: 'https://music.163.com/song/media/outer/url?id=1418131597.mp3',
      cover: 'https://p2.music.126.net/Qjc3qyumYfFrpXheCtYIxQ==/109951164643480793.jpg?param=130y130'
    }
  ],
  ...
  MUSIC_PLAYER_METING_ID: process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '8202227556', // 对应歌单的 id
  MUSIC_PLAYER_METING_LRC_TYPE: process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_LRC_TYPE || '0', // 可选值： 3 | 1 | 0（0：禁用 lrc 歌词，1：lrc 格式的字符串，3：lrc 文件 url）
